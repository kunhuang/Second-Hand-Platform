...
//		AddGoodsButton = (Button) findViewById(R.id.regist);
//		addGoodsNameText = (EditText) findViewById(R.id.addGoodsName);
//		addGoodsPriceText = (EditText) findViewById(R.id.addGoodsPrice);
//		sellerNameText = (EditText) findViewById(R.id.addSellerName);
